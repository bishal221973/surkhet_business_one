<div class="col-md-3  mb-3" >
    <div class="list-group bg-warning shadow1">
        ...
        <a href="{{ route('notification.setting') }}" class="setting-menu list-group-item list-group-item-action {{ Route::currentRouteName() == 'notification.setting' ? 'active' : '' }}">Notification Setting</a>
